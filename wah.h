...
#define WAH_OPCODES(X) \
    ...
    X(MEMORY_SIZE, 0x3F) X(MEMORY_GROW, 0x40) X(MEMORY_INIT, 0xC008) X(MEMORY_COPY, 0xC00A) X(MEMORY_FILL, 0xC00B) \
    \
    /* Vector Memory Operators */ \
    X(V128_LOAD, 0xD000) \
    X(V128_LOAD8X8_S, 0xD001) X(V128_LOAD8X8_U, 0xD002) \
    X(V128_LOAD16X4_S, 0xD003) X(V128_LOAD16X4_U, 0xD004) \
    X(V128_LOAD32X2_S, 0xD005) X(V128_LOAD32X2_U, 0xD006) \
    X(V128_LOAD8_SPLAT, 0xD007) X(V128_LOAD16_SPLAT, 0xD008) X(V128_LOAD32_SPLAT, 0xD009) X(V128_LOAD64_SPLAT, 0xD00A) \
    X(V128_LOAD32_ZERO, 0xD05C) X(V128_LOAD64_ZERO, 0xD05D) \
    ...
    X(V128_NOT, 0xD04D) X(V128_AND, 0xD04E) X(V128_ANDNOT, 0xD04F) X(V128_OR, 0xD050) X(V128_XOR, 0xD051) \
    X(I8X16_ADD, 0xD06E) X(I8X16_ADD_SAT_S, 0xD06F) X(I8X16_ADD_SAT_U, 0xD070) \
    X(I8X16_SUB, 0xD071) X(I8X16_SUB_SAT_S, 0xD072) X(I8X16_SUB_SAT_U, 0xD073) \
    X(I16X8_ADD, 0xD08E) X(I16X8_ADD_SAT_S, 0xD08F) X(I16X8_ADD_SAT_U, 0xD090) \
    X(I16X8_SUB, 0xD091) X(I16X8_SUB_SAT_S, 0xD092) X(I16X8_SUB_SAT_U, 0xD093) \
    X(I16X8_MUL, 0xD095) \
    X(I32X4_ADD, 0xD0AE) X(I32X4_SUB, 0xD0B1) X(I32X4_MUL, 0xD0B5) \
    X(I64X2_ADD, 0xD0CE) X(I64X2_SUB, 0xD0D1) X(I64X2_MUL, 0xD0D5) \
    ...
    X(I32_TRUNC_SAT_F32_S, 0xC000) X(I32_TRUNC_SAT_F32_U, 0xC001) X(I32_TRUNC_SAT_F64_S, 0xC002) X(I32_TRUNC_SAT_F64_U, 0xC003) \
    X(I64_TRUNC_SAT_F32_S, 0xC004) X(I64_TRUNC_SAT_F32_U, 0xC005) X(I64_TRUNC_SAT_F64_S, 0xC006) X(I64_TRUNC_SAT_F64_U, 0xC007)
