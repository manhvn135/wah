...
static int test_all_hang_wasm_parsing_errors() {
    ...
    struct {
    ...
    } hang_tests[] = {
        {
            .binary = (const uint8_t[]){
                ...
                0xf1, 0x7e, 0x7f, 0x01, 0x7f, 0x03, 0x02, 0x01, 0x00, 0x00, 0x0a, 0x01,
                0x00, 0x40, 0x42, 0x64, 0x54, 0xfc, 0x03, 0x00, 0x00, 0x61, 0x73, 0x6d,
                0x01, 0x00, 0x00, 0x00, 0x01, 0x07, 0x01, 0x60, 0x02, 0x69, 0x01, 0x77,
                0x6f, 0x40, 0x00, 0x0a, 0x10, 0x01, 0xf9, 0x20, 0x06, 0x00, 0x00, 0xfc,
                0x03, 0x00, 0x00, 0x61, 0x02, 0x01
            },
            .len = 66,
        ...
        {
            .binary = (const uint8_t[]){
                0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00, 0x01, 0x07, 0xbd, 0xbd,
                0xbd, 0xbd, 0x00, 0xbd, 0xbd, 0xbd, 0xad, 0xbd, 0xa9, 0xce, 0xbd, 0xbd,
                0x0e, 0xbd, 0xbd, 0xbd, 0x00, 0xbd, 0xbd, 0xbd, 0xad, 0xbd, 0xa9, 0xbd,
                0xbd, 0xbd, 0x00, 0xbd, 0xff, 0xff, 0xff, 0xff, 0xa9, 0xbd, 0xbd, 0xbd,
                0xc3, 0xbd, 0x04, 0xc3, 0xbd, 0x76, 0x28, 0x00, 0x00
            },
            .len = 57,
            .name = "large_type_section_count_1"
        },
        {
            .binary = (const uint8_t[]){
                0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00, 0x04, 0x15, 0x90, 0xff,
                0xff, 0xe8, 0x03, 0x00, 0x04, 0x15, 0x90, 0xff, 0xff, 0xe8, 0x03, 0x00,
                0x82, 0x73, 0x6c, 0xea, 0x00, 0x0a, 0x00, 0x00, 0x00, 0x7f, 0x60, 0x02,
                0x7f, 0x7f, 0x01, 0x7f, 0x03, 0x02, 0x01, 0x00, 0x00, 0x0a, 0xff, 0x80,
                0x00, 0x10, 0x01, 0xb9
            },
            .len = 52,
    ...
    for (size_t i = 0; i < sizeof(hang_tests) / sizeof(hang_tests[0]); ++i) {
        ...
        if (err == WAH_ERROR_VALIDATION_FAILED) {
            ...
            fprintf(stderr, "Assertion failed: Expected WAH_ERROR_VALIDATION_FAILED for %s, but got %s\n", hang_tests[i].name, wah_strerror(err));
            wah_free_module(&module);
            return 1;
        }
    }
